...
#### Full Guide : [Mutt_Proton_Mail_Bridge_Guide](https://github.com/Jim-JMCD/mutt-protonmail-bridge/blob/main/Mutt_Proton_Mail_Bridge_Guide.pdf)  
...
At time of writing; The only Proton supported mail client for the Linux Proton Mail Bridge is Thunderbird.  Proton Mail Bridge is not supported ARM devices other than M-series Macs.
...
1.Start protonmail-bridge interactively to initialise and sync protonmail-bridge. The protonmail-bridge is configured only for the designated user account and creates a database within the home directory of that user. The sync process may take hours with large accounts that contain 10,000+ emails.
